...
public class PacienteController {
    ...
    } // en la firma ponemos  ? porque podemos retornar un Paciente o otra cosa (como un mensaje "paciente no encontrado")

    @GetMapping("/buscartodos")
    public ResponseEntity<List<Paciente>> buscarTodos(){
        return ResponseEntity.ok(pacienteService.buscarTodos());
    } //generalmente ponemos ok porque siempre se devuelve algo, al menos un array vacio
